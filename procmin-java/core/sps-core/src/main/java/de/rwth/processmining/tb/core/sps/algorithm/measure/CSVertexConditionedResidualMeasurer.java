...
import de.rwth.processmining.tb.core.sps.data.csgraph.PerspectiveCSConditionResidual;
...
public class CSVertexConditionedResidualMeasurer
  ...
  extends CSVertexMeasurerBase<V, F, D> {
	...
	private final static PerspectiveDescriptor pDesc = new PerspectiveCSConditionResidual();
	...
	public CSVertexConditionedResidualMeasurer(CSGraph csGraph, 
	...
	protected HFDDVertexMeasurerImpl<V, F, D> getMeasurer(BiComparisonDataSource<? extends V> biCompDS) {
		...
		transformersOuterContext.add(residualTransformer);
	...
	protected CSMeasurementTypes getMeasurementType() {
		return CSMeasurementTypes.CONDITIONED_RESIDUAL;
	}
}
